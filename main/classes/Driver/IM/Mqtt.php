...
final class Mqtt
    ...
    public function broker($address, $port, $clientid) {
    ...
    public function connect($clean = true, $will = NULL, $username = NULL, $password = NULL) {
        ...
        $address = gethostbyname($this->address); // TODO
        $this->socket = fsockopen($address, $this->port, $errno, $errstr, 60); // TODO timeout
        ...
        stream_set_timeout($this->socket, 5); // I/O timeout
        stream_set_blocking($this->socket, 0); // non-block
    ...
    private function proc($loop = true) {
